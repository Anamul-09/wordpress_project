            ...
            if ( $count_post > 0 ) {
                ...
                if ( ! empty($loop->results) ) {
                    foreach ( $loop->results as $cs_user ) {
                        ...
                        $cs_employee_emp_username = isset($cs_user->user_login) ? $cs_user->user_login : '';
                        $cs_employee_comp_name = isset($cs_user->display_name) ? $cs_user->display_name : '';
                            ...
                            <div class="cs-post-type">
                                <span class="cs-btn-holder">
                                    ...
                                    <a href="javascript:void(0)">
                                        <span class="cs-color"><?php echo esc_html($count_job_post); ?></span> <?php  echo ($vacancy_text);  ?>
                                    </a>
                                </span>
                            </div>
                        </li>
