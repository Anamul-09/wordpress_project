<?php if (!class_exists('jobcareer8290career_options_fields')) {

    class jobcareer8290career_options_fields {
	 ...
	 */
	public function jobcareer8290career_cs_fields($cs_setting_options) {
			...
			$output .= '<script type="text/javascript">
                                        ...
                                        jQuery(document).ready(function () {
                                            ...
                                            if( cs_map_type == \'llmaps\'){
                                                ...
                                                var mapConfigs = {
                                                    center: ["'.$cs_post_loc_latitude.'", "'.$cs_post_loc_longitude.'"],
                                                    zoom: 5,
                                                    map_type: \'default\',
                                                }
                                                ...
                                                var markersArray = [];
                                                var markerData = {
                                                    latitude: "'.$cs_post_loc_latitude.'",
                                                    longitude: "'.$cs_post_loc_longitude.'",
                                                }
